...
public class ChatRLAgent {
    ...
    public static void main(String[] args) {
        ...
        int muestraSize = Math.min(20, RESPUESTAS_CORRECTAS.size());
        List<String> preguntasMuestra = RESPUESTAS_CORRECTAS.keySet().stream()
                .limit(muestraSize)
                .collect(Collectors.toList());

        for (String pregunta : preguntasMuestra) {
